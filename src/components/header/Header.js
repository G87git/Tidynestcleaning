                                ...
                                <div className="header-right">
                                    <div className="header-search-form-wrapper">
                                        <div className="cart-search-contact">
                                            <button onClick={() => setMenuState(!menuActive)} className="search-toggle-btn"><a href="tel:+44 07958569110" ><i
                                                className={`fa fa-phone`}></i></a></button>
                                        </div>
                                    </div>

                                    <div className="close-form">
                                        <a onClick={ClickHandler} className="theme-btn" href="tel:+44 07958569110"> <i className="fa fa-phone"
                                            aria-hidden="true"></i>
                                            <span>Get Free Estimate</span>+44 07958569110</a>
                                    </div>
                                </div>
                            </div>
                        </div>
